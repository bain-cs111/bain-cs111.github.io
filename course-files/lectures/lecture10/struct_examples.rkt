...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 6-notes) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; posn examples
