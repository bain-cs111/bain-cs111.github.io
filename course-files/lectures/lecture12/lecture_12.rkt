...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |9 - Iterative Recursion Notes|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
