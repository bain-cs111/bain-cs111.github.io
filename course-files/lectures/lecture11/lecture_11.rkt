...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname lecture_11) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Recursion on Lists
