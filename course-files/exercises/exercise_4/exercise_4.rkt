...
; can't be used to implement your functions but helpful for testing
;  to see if your versions work identically!
...
(define prof-bains-stamp-collection
...
; This should pass...but doesn't! Fix the func definition below!
(check-expect (total-value prof-bains-stamp-collection)
              21510)
...
; THAT MEANS WE AREN'T CHECKING YOUR FUNCTIONS OUTPUTS FOR YOU.
