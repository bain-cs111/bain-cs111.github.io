...
(module+ test
  ...
  (check-define-struct-message
   @string-append{
   define-struct: expected attribute names (in parenthesis) after the structure name, but nothing's there.
  ...
  (check-define-struct-message
   @string-append{
   define-struct: expected attribute names (in parenthesis) after the structure name, but found something else: #:methds
   }
   @run-in-htdp-asl{
   (define-struct S (x y)
     #:methods
  ...
  (check-define-struct-message
   @string-append{
   define-struct: expected attribute names (in parenthesis) after the structure name, but found something else: #:methods
    If the structure has no (extra) attributes, put an empty pair of parenthese there.
   }
   @run-in-htdp-asl{
   (define-struct S (x y)
  ...
  (check-define-struct-message
   @string-append{
   define-struct: found an attribute name that is used more than once: y
   }
   @run-in-htdp-asl{
   (define-struct S (x))
  ...
  (check-define-struct-message
   @string-append{
   define-struct: the structure X has missing attributes: i
   }
   @run-in-htdp-asl{
  ...
  (check-define-struct-message
   @string-append{
   define-struct: the structure X has missing attributes: j
   }
   @run-in-htdp-asl{
   (define-struct-name-specification X
     #:fields (i j)
  ...
  (check-define-struct-message
   @string-append{
   define-struct: the structure X has extra attributes: k
   }
   @run-in-htdp-asl{
   (define-struct-name-specification X
     #:fields (i j)
  ...
  (check-define-struct-message
   @string-append{
   define-struct: expected the structure X with attributes: i, j and k
     given the attributes with a different order: j, k and i
   }
   @run-in-htdp-asl{
   (define-struct-name-specification X
     #:fields (i j k)
  ...
  (check-define-struct-message
   @string-append{
   define-struct: expected a structure definition without any parent type
     given parent type: S
   }
   @run-in-htdp-asl{
   (define-struct-name-specification X
  ...
  (check-define-struct-message
   @string-append{
   define-struct: expected a structure definition with the parent type `S`
     given: no parent type
   }
   @run-in-htdp-asl{
   (define-struct-name-specification X
     #:super S
