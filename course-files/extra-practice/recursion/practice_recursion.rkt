...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname practice_recursion) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
